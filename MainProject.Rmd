...
ggplot(data2, aes(x = Library_Income, y = Family_Income)) + 
  geom_point() + 
  labs(x = "Library Funding", y = "Median Family Income", title = "The Relationship between Income and Library Funding")
ggplot(data2) + 
