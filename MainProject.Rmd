...
plot(x = computer_usage_graph$Income, y = computer_usage_graph$Wireless_Internet_Uses/computer_usage_graph$Total_Population, 
  xlab = "Income", ylab = "Wireless Usage", main = "Wireless Usage v. County Population")
```
```{r}
