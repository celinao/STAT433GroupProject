...
map_data("county")%>%
  filter(region == "wisconsin")%>%
  left_join(plot_map, by=c("subregion"="County")) %>% 
  ggplot(aes(x = long, y = lat, outline = subregion, fill = Income_Familes)) +
  geom_polygon(colour = "grey50") +
  scale_fill_continuous(type = "viridis", na.value = "grey80") + 
  theme(axis.line=element_blank(),
        axis.text=element_blank(),
...
ggplot(data2, aes(Library_Income/100000)) + 
  geom_histogram(color = "black", fill = "grey") + 
  labs(x = "Library Funding (100k dollars)", y = "Count", title = "Library Funding per County")+ 
  scale_x_continuous(breaks = seq(0, 500, 50))

ggplot(data2, aes(num_libraries)) + 
  geom_histogram(color = "black", fill = "grey") + 
  labs(x = "Number of Libraries", y = "Count", title = "Number of Libraries per County") + 
  scale_x_continuous(breaks = seq(0, 20, 2))

ggplot(data2, aes(Computer_Usage/1000)) + 
  geom_histogram(color = "black", fill = "grey") + 
  labs(x = "Computer Usage (1k Uses)", y = "Count", title = "Computer Usages per County") +
  scale_x_continuous(breaks = seq(0, 600, 100))

ggplot(data2, aes(Num_Computers)) + 
  geom_histogram(color = "black", fill = "grey") + 
  labs(x = "Number of Computers", y = "Count", title = "Number of Public Library Computers per County") +
...
ggplot(data2, aes(Library_Visits/1000)) + 
  geom_histogram(color = "black", fill = "grey") + 
  labs(x = "Library Visits (1k Visits)", y = "Count", title = "Library Visits Populations") 
```
